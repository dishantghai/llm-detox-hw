...
DPO_PATH = Path("data/dpo.jsonl")  # reused from the original homework run
OUT_JSON = Path("attempt_2/submissions/chosen_evasiveness_audit.json")
OUT_TXT = Path("attempt_2/submissions/chosen_evasiveness_audit.txt")
